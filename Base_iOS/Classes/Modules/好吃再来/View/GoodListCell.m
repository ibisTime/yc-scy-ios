...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        //时间
        self.sloganLbl = [UILabel labelWithFrame:CGRectMake(self.nameLbl.x, self.nameLbl.yy + 20, self.nameLbl.width, [FONT(11) lineHeight])
        ...
        //
        self.statusBtn = [UIButton buttonWithTitle:@"选择" titleColor:kWhiteColor backgroundColor:kAppCustomMainColor titleFont:13.0 cornerRadius:5];
        
        [self.statusBtn addTarget:self action:@selector(selectGood:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)selectGood:(UIButton *)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(didSelectActionWithIndex:)]) {
        
        [self.delegate didSelectActionWithIndex:index];
    }
}
